...
export const Timeline = () => {
    return (
      <div className="relative w-full flex flex-col items-center p-8">
        {/* Cuerdas de guitarra */}
        <div className="absolute left-1/2 transform -translate-x-1/2 w-2 bg-gray-800 h-full"> {/* Aumentado el ancho a w-4 */}
          <div className=" h-full w-1 rounded-full"></div> {/* Degradado para simular profundidad */}
        </div>
        {/* Timeline Items */}
