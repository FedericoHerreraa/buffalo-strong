...
export const StockReference = () => {
    ...
    return (
        <div className="flex md:flex-row md:w-fit w-full flex-col items-center gap-5 text-zinc-500 font-semibold border border-zinc-200  p-5 md:rounded-lg rounded-md bg-zinc-50">
